...
<dependency>
    ...
    <scope>system</scope>
    <systemPath>${project.basedir}/lib/eSignASPLibrary5_10.jar</systemPath>
</dependency>
...
For the PAN/V2 flow, the temp file follows the pattern `{tempFolder}/{transactionID}.sig`, so you can reconstruct it from the transaction ID.
