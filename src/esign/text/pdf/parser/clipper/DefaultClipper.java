...
import static esign.text.pdf.parser.clipper.Clipper.PRESERVE_COLINEAR;
import static esign.text.pdf.parser.clipper.Clipper.REVERSE_SOLUTION;
import static esign.text.pdf.parser.clipper.Clipper.STRICTLY_SIMPLE;
import static esign.text.pdf.parser.clipper.ClipperBase.parseFirstLeft;
import esign.text.pdf.parser.clipper.Path.Join;
import esign.text.pdf.parser.clipper.Path.OutRec;
import esign.text.pdf.parser.clipper.Point.LongPoint;
...
public class DefaultClipper extends ClipperBase {
    ...
    private void insertScanbeam(long  Y)
    {
        ...
        if (scanbeam == null)
        {
            scanbeam = new ClipperBase.Scanbeam();
            scanbeam.next = null;
            scanbeam.y = Y;
        }
...
//    }
    ...
    private void processHorizontal( Edge horzEdge ) {
        ...
        final Clipper.Direction[] dir = new Clipper.Direction[1];
        ...
        for (;;) { //loop through consec. horizontal edges
            ...
            while (e != null) {
                ...
                if (dir[0] == Clipper.Direction.LEFT_TO_RIGHT && e.getCurrent().getX() > horzRight[0] || dir[0] == Clipper.Direction.RIGHT_TO_LEFT
