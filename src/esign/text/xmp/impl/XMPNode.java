...
class XMPNode
    ...
    public void sort() {
        if (hasQualifier()) {
            ...
            XMPNode[] quals = (XMPNode[]) getQualifier().toArray((Object[]) new XMPNode[getQualifierLength()]);
            int sortFrom = 0;
            ...
            Arrays.sort((Object[]) quals, sortFrom, quals.length);
    ...
    private void dumpNode(StringBuffer result, boolean recursive, int indent, int index) {
        ...
        if (recursive && hasQualifier()) {
            ...
            Arrays.sort((Object[]) quals, j, quals.length);
        ...
        if (recursive && hasChildren()) {
            ...
            XMPNode[] children = (XMPNode[]) getChildren().toArray((Object[]) new XMPNode[getChildrenLength()]);
            if (!getOptions().isArray()) {
